...
final class DeviceTypeCollectionViewController: UITableViewController {
    ...
    private let deviceSizes = IDeviceType.allCases
...
extension DeviceTypeCollectionViewController {
